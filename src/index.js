...
function dogCardMaker({ imageURL, breed }) {
  ...
  */
  ...
  console.log(dogCard); //sanity check
...
//    * Projects with npm: install it with npm and import it into this file  ---> the method that we will use

axios.get(' https://dog.ceo/api/breeds/image/random')
.then(res => { const dogCard = dogCardMaker({imageURL: res.data.message, breed: "Casey"});
